...
class NonCollisionMapTest {
    ...
    @Test
    void whenPutNewUniqueKeysShouldReturnTrue() {
    ...
    @Test
    void whenPutExistingKeyShouldReturnFalse() {
        assertThat(map.put(1, "10")).isFalse();
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map).hasSize(4);
    }
    ...
    @Test
    void whenGetExistingKeyShouldReturnValue() {
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map.get(2)).isEqualTo("2");
    }

    @Test
    void whenGetNonExistingKeyShouldReturnNull() {
        assertThat(map.get(10)).isNull();
        assertThat(map.get(20)).isNull();
    }

    @Test
    void whenRemoveExistingKeyShouldReturnTrueAndUpdateSize() {
        assertThat(map.remove(1)).isTrue();
        assertThat(map).hasSize(3);
    }

    @Test
    void whenRemoveNonExistingKeyShouldReturnFalse() {
        assertThat(map.remove(10)).isFalse();
        assertThat(map).hasSize(4);
    }

    @Test
    void whenIterateShouldReturnAllKeysInOrder() {
        Iterator<Integer> iterator = map.iterator();
        assertThat(iterator.next()).isEqualTo(1);
    ...
    @Test
    void whenIterateAndModifyMapShouldThrowConcurrentModificationException() {
        Iterator<Integer> iterator = map.iterator();
        map.put(5, "5");
